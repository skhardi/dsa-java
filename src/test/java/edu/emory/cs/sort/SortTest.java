...
public class SortTest {
    ...
    public void testRuntime() {
        testRuntime(InputNature.RANDOM, new HeapSort<>(), new ShellSortKnuth<>(), new SelectionSort<>(), new InsertionSort<>());
        testRuntime(InputNature.RANDOM, new HeapSort<>(), new ShellSortKnuth<>(), new MergeSort<>(), new QuickSort<>(), new IntroSort<>(new HeapSort<Integer>()), new IntroSort<>(new ShellSortKnuth<Integer>()));
        testRuntime(InputNature.RANDOM, new HeapSort<>(), new ShellSortKnuth<>(), new MergeSort<>(), new QuickSort<>(), new IntegerBucketSort(0, 10000), new LSDRadixSort());
    }

    @SafeVarargs
    public final void testRuntime(InputNature nature, AbstractSort<Integer>... engines) {
        Time[] times;
        ...
        for (int size = init_size; size <= max_size; size += inc) {
            ...
            times = benchmark(engines, iter, size, nature);
